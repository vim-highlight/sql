...
" Entities: {{{
    " NOT: {{{
function! s:DefineEntity_Not (block, included)
        " ---
        " Define NOT keyword in a block
        "   block:      Name of declaring block
        "   included:   Include in another define ?
        " ---
...
function! s:DefineEntity_Function (block)
    ...
    " }}}
    " Group: () {{{
function! s:DefineEntity_Group (block, included)
        " ---
        " Define `group` (delimited by parenthesis) in a block
        "   block:      Name of declaring block
        "   included:   Include in another define ?
        " ---
...
function! s:DefineEntity_Null (block)
        " ---
        " Define NULL keyword in a block
        "   block:      Name of declaring block
        " ---
